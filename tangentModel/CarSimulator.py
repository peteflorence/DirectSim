...
from normalApproximator import NormalApproximatorObj
...
class Simulator(object):
    ...
    def initializeOptions(self):
        ...
        self.options['World']['obstaclesInnerFraction'] = 0.5
        self.options['World']['randomSeed'] = 40
        self.options['World']['percentObsDensity'] = 5
    ...
    def setDefaultOptions(self):
        ...
        defaultOptions['World']['obstaclesInnerFraction'] = 0.5
        defaultOptions['World']['randomSeed'] = 40
        defaultOptions['World']['percentObsDensity'] = 5
        defaultOptions['World']['nonRandomWorld'] = True
        defaultOptions['World']['circleRadius'] = 1.75
        defaultOptions['World']['scale'] = 1
    ...
    def initialize(self):
        ...
        self.NormalApproximator = NormalApproximatorObj(numRays=self.options['Sensor']['numRays'], circleRadius=self.options['World']['circleRadius'], )

        self.Controller = ControllerObj(self.Sensor, self.NormalApproximator)
    ...
    def setupPlayback(self):
        ...
        self.frame.connectFrameModified(self.NormalApproximator.updateDrawNormals)
        self.updateDrawIntersection(self.frame)
        self.NormalApproximator.updateDrawNormals(self.frame)
